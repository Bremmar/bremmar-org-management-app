...
function MeetingPrepView({ workspace, team, readOnly, meetings, rocks, todos, issues, metrics, scorecardResults, headlines, onNavigate, onSaveScorecardResult, onUpdateRockStatus, onUpdateTodo, onOpenTodo, onOpenIssue, onAddIssue, onCreateHeadline }: MeetingPrepViewProps) {
  ...
  return <>
    <PageHeader eyebrow={`${team.name.toUpperCase()} · MEETING PREP`} title="Come ready to the room." description="Prepare the work you own before the L10 starts. Updates are saved to the same team records the meeting will use." actions={<Button variant="secondary" onClick={() => onNavigate('meeting')}>Open Live L10 →</Button>} />
